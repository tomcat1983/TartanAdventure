...
public class Map {
	...
	public static Room mission() {
		...
		String planeDescription = "You are on an airplane. You are on a top secret mission. Your objective is to parachute into a field, nearby a CIA complex, and retrieve the secret file. You must hurry, because B-2 Bombers are on their way to annihilate the complex.";
		...
		String aliensBD = "This one is of the likeness of James Bond.";
		...
		String archivesAFD = "You are standing in front of shelves with documents on CIA suspects with last names A-F. The secret folder is sitting on the shelf.";
		...
		String cabinD = "";
		String cabinDeathMessage = "You are pulled into the chopper by a comrade's arm. You are now inside the chopper. You are betrayed by the pilot and thrown out the door of the chopper.";
		...
		String locked1SD = "Type 'lookAround'";
		String locked2D = "How the hell did you get in here?";
		String locked2SD = "Type 'lookAround'";
		...
		sub1.setText(" * Steal secret file.\n * Get out of there!");
		ItemWatchMenu sub2 = new ItemWatchMenu("About the author");
		sub2.setText("This is an adventure game for CMU");
		main.add(sub1);
		main.add(sub2);
		watch.setMenu(main);
		...
		guard.setDeathMessage("You fight with the guard.");
		booth.putItem(guard);
		...
		serviceE.setDeathMessage("As you take your first step, you suddenly become engulfed in a bright light. You lookAround up and see a guard shining a serach light on you. He shoots you.");
		...
		rooftop.setDeathMessage("The complex exploded before you could escape with the file. You have failed your mission.");
