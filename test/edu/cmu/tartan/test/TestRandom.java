...
/*    @Test
    ...
    public void test18() throws Throwable {
        ...
        boolean boolean12 = itemDynamite4.equals(str11);
    ...
    public void test26() throws Throwable {
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit19 = new edu.cmu.tartan.action.ActionExecutionUnit(itemClayPot8, itemMicrowave18);
    ...
    public void test30() throws Throwable {
        ...
        roomObscured6.setOneWayAdjacentRoom(action7, roomObscured10);
        roomObscured2.setAdjacentRoomTransitionMessageWithDelay("hi!", action7, '4');
        ...
        edu.cmu.tartan.Player player31 = new edu.cmu.tartan.Player(roomObscured2, itemList29);
    ...
    public void test31() throws Throwable {
        ...
        customizingGame0.addGoal(gameExploreGoal3);
    ...
    public void test33() throws Throwable {
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit51 = new edu.cmu.tartan.action.ActionExecutionUnit(itemVendingMachine41, itemBrick47);
        player31.score(itemVendingMachine41);
    ...
    public void test38() throws Throwable {
        ...
        edu.cmu.tartan.goal.GameExploreGoal gameExploreGoal5 = new edu.cmu.tartan.goal.GameExploreGoal(strList3);
        ...
        roomObscured8.setOneWayAdjacentRoom(action9, roomObscured12);
        edu.cmu.tartan.Player player14 = new edu.cmu.tartan.Player(roomObscured12);
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit36 = new edu.cmu.tartan.action.ActionExecutionUnit(itemVendingMachine26, itemBrick32);
        try {
            player14.putItemInItem(item16, itemVendingMachine26);
    ...
    public void test46() throws Throwable {
        ...
        boolean boolean11 = itemFolder9.equals((byte) 10);
    ...
    public void test47() throws Throwable {
        ...
        boolean boolean17 = itemClayPot8.equals(strArray14);
        assertNotNull(strArray6);
    ...
    public void test53() throws Throwable {
        ...
        roomObscured26.setOneWayAdjacentRoom(action27, roomObscured30);
        roomObscured22.setAdjacentRoomTransitionMessageWithDelay("hi!", action27, '4');
        itemClayPot8.setRelatedRoom(roomObscured22);
        ...
        roomObscured22.setObscuringItem(itemBrick41);
        assertNotNull(strArray6);
        assertTrue("'" + action15 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action15.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
        assertNotNull(strArray16);
    ...
    public void test54() throws Throwable {
        ...
        try {
            java.lang.String str4 = xmlResponseAddUser0.getAttributeValueAtNthTag("I don't see that here.", nodeList2, (byte) 100);
            fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        }
    }
    ...
    public void test55() throws Throwable {
        ...
        edu.cmu.tartan.action.Action action3 = edu.cmu.tartan.action.Action.ACTION_EXPLODE;
        edu.cmu.tartan.room.RoomObscured roomObscured6 = new edu.cmu.tartan.room.RoomObscured("hi!", "hi!");
        roomObscured2.setOneWayAdjacentRoom(action3, roomObscured6);
        edu.cmu.tartan.Player player8 = new edu.cmu.tartan.Player(roomObscured6);
        edu.cmu.tartan.action.Action action10 = edu.cmu.tartan.action.Action.ACTION_GO_WEST;
        roomObscured6.setAdjacentRoomTransitionMessageWithDelay("", action10, ' ');
        assertTrue("'" + action3 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action3.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
...
/*    @Test
    ...
    public void test63() throws Throwable {
        ...
        edu.cmu.tartan.Player player14 = new edu.cmu.tartan.Player(roomObscured12);
        gameExploreGoal5.setPlayer(player14);
        player14.addPossiblePoints((byte) 100);
        assertNotNull(strArray2);
        assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        assertTrue("'" + action9 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action9.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
    }
    ...
    public void test66() throws Throwable {
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit22 = new edu.cmu.tartan.action.ActionExecutionUnit(itemVendingMachine12, itemBrick18);
        edu.cmu.tartan.room.RoomLockable roomLockable23 = new edu.cmu.tartan.room.RoomLockable("I don't see that here.", "hi!", false, itemVendingMachine12);
        assertNotNull(strArray9);
    ...
    public void test68() throws Throwable {
        ...
        edu.cmu.tartan.action.Action action23 = edu.cmu.tartan.action.Action.ACTION_EXPLODE;
        edu.cmu.tartan.room.RoomObscured roomObscured26 = new edu.cmu.tartan.room.RoomObscured("hi!", "hi!");
        roomObscured22.setOneWayAdjacentRoom(action23, roomObscured26);
        roomObscured18.setAdjacentRoomTransitionMessageWithDelay("hi!", action23, '4');
        ...
        edu.cmu.tartan.Player player47 = new edu.cmu.tartan.Player(roomObscured18, itemList45);
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit67 = new edu.cmu.tartan.action.ActionExecutionUnit(itemVendingMachine57, itemBrick63);
        player47.score(itemVendingMachine57);
        boolean boolean69 = player14.pickup(itemVendingMachine57);
    ...
    public void test70() throws Throwable {
        ...
        roomObscured3.setOneWayAdjacentRoom(action4, roomObscured7);
        edu.cmu.tartan.Player player9 = new edu.cmu.tartan.Player(roomObscured7);
        java.lang.String str10 = roomObscured7.description();
        edu.cmu.tartan.action.Action action11 = room0.getDirectionForRoom(roomObscured7);
    ...
    public void test71() throws Throwable {
        ...
        boolean boolean8 = roomObscured2.isAdjacentToRoom(roomObscured5);
        edu.cmu.tartan.action.Action action9 = edu.cmu.tartan.action.Action.ACTION_EXPLODE;
        edu.cmu.tartan.room.RoomObscured roomObscured12 = new edu.cmu.tartan.room.RoomObscured("hi!", "hi!");
        ...
        roomObscured12.setOneWayAdjacentRoom(action13, roomObscured16);
        ...
        roomObscured5.setOneWayAdjacentRoom(action9, roomObscured16);
    ...
    public void test76() throws Throwable {
        ...
        itemMagicBox15.install(itemGold20);
        assertNotNull(strArray10);
        assertNotNull(strArray12);
    ...
    public void test77() throws Throwable {
        ...
        edu.cmu.tartan.goal.GameExploreGoal gameExploreGoal6 = new edu.cmu.tartan.goal.GameExploreGoal(strList4);
        ...
        roomObscured9.setOneWayAdjacentRoom(action10, roomObscured13);
        edu.cmu.tartan.Player player15 = new edu.cmu.tartan.Player(roomObscured13);
        ...
        roomObscured23.setOneWayAdjacentRoom(action24, roomObscured27);
        roomObscured19.setAdjacentRoomTransitionMessageWithDelay("hi!", action24, '4');
        ...
        edu.cmu.tartan.Player player48 = new edu.cmu.tartan.Player(roomObscured19, itemList46);
        ...
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit68 = new edu.cmu.tartan.action.ActionExecutionUnit(itemVendingMachine58, itemBrick64);
        player48.score(itemVendingMachine58);
        boolean boolean70 = player15.pickup(itemVendingMachine58);
        edu.cmu.tartan.goal.GamePointsGoal gamePointsGoal71 = new edu.cmu.tartan.goal.GamePointsGoal(0, player15);
        assertNotNull(strArray3);
    ...
    public void test78() throws Throwable {
        ...
        itemMicrowave18.install(itemTorch24);
        assertNotNull(strArray6);
        assertTrue("'" + action15 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action15.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
        assertNotNull(strArray16);
    ...
    public void test79() throws Throwable {
        ...
        roomObscured16.setOneWayAdjacentRoom(action17, roomObscured20);
        roomObscured12.setAdjacentRoomTransitionMessageWithDelay("hi!", action17, '4');
        ...
        edu.cmu.tartan.Player player41 = new edu.cmu.tartan.Player(roomObscured12, itemList39);
        java.util.List<edu.cmu.tartan.item.Item> itemList42 = null;
        edu.cmu.tartan.Player player43 = new edu.cmu.tartan.Player(roomObscured12, itemList42);
        roomObscured6.setOneWayAdjacentRoom(action9, roomObscured12);
        assertTrue("'" + action3 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action3.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
    ...
    public void test84() throws Throwable {
        ...
        itemClayPot8.setRelatedRoom(roomObscured22);
        java.lang.String str35 = roomObscured22.visibleItems();
        edu.cmu.tartan.Player player36 = new edu.cmu.tartan.Player(roomObscured22);
        assertNotNull(strArray6);
        assertTrue("'" + action15 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action15.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
        assertNotNull(strArray16);
        assertTrue("'" + action27 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action27.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
    ...
    public void test85() throws Throwable {
        ...
        edu.cmu.tartan.goal.GameExploreGoal gameExploreGoal44 = new edu.cmu.tartan.goal.GameExploreGoal(strList42);
        ...
        roomObscured47.setOneWayAdjacentRoom(action48, roomObscured51);
        edu.cmu.tartan.Player player53 = new edu.cmu.tartan.Player(roomObscured51);
        gameExploreGoal44.setPlayer(player53);
        boolean boolean55 = itemClayPot37.equals(gameExploreGoal44);
        itemSafe28.install(itemClayPot37);
        edu.cmu.tartan.action.ActionExecutionUnit actionExecutionUnit57 = new edu.cmu.tartan.action.ActionExecutionUnit(itemMicrowave18, itemClayPot37);
        assertNotNull(strArray6);
        assertTrue("'" + action15 + "' != '" + edu.cmu.tartan.action.Action.ACTION_EXPLODE + "'", action15.equals(edu.cmu.tartan.action.Action.ACTION_EXPLODE));
        assertNotNull(strArray16);
    ...
    public void test86() throws Throwable {
        ...
        java.lang.String[] strArray8 = new java.lang.String[] { "", "hi!" };
        edu.cmu.tartan.item.ItemBrick itemBrick9 = new edu.cmu.tartan.item.ItemBrick("", "hi!", strArray8);
        edu.cmu.tartan.room.RoomRequiredItem roomRequiredItem10 = new edu.cmu.tartan.room.RoomRequiredItem("Demo goal", "I don't see that here.", "I don't see that here.", "hi!", itemBrick9);
    ...
    public void test87() throws Throwable {
        ...
        edu.cmu.tartan.goal.GameExploreGoal gameExploreGoal9 = new edu.cmu.tartan.goal.GameExploreGoal(strList7);
        edu.cmu.tartan.room.RoomObscured roomObscured12 = new edu.cmu.tartan.room.RoomObscured("hi!", "hi!");
        edu.cmu.tartan.action.Action action13 = edu.cmu.tartan.action.Action.ACTION_EXPLODE;
        edu.cmu.tartan.room.RoomObscured roomObscured16 = new edu.cmu.tartan.room.RoomObscured("hi!", "hi!");
        roomObscured12.setOneWayAdjacentRoom(action13, roomObscured16);
        edu.cmu.tartan.Player player18 = new edu.cmu.tartan.Player(roomObscured16);
        gameExploreGoal9.setPlayer(player18);
        edu.cmu.tartan.goal.GameCollectGoal gameCollectGoal20 = new edu.cmu.tartan.goal.GameCollectGoal(strList2, player18);
